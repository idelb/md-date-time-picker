    ...
    */
    ...
    _createClass(mdDateTimePicker, [{
      ...
      value: function _selectDialog() {
        ...
        * @type {Array}
        */
        var sDialogEls = ['viewHolder', 'years', 'header', 'cancel', 'ok', 'left', 'right', 'previous', 'current', 'next', 'subtitle', 'title', 'titleDay', 'titleMonth', 'AM', 'PM', 'needle', 'hourView', 'minuteView', 'secondView', 'hour', 'minute', 'second', 'fakeNeedle', 'circularHolder', 'circle', 'dotSpan'],
            i = sDialogEls.length;
      ...
      value: function _hideDialog() {
        var me = this,
            ...
            secondView = this._sDialog.secondView,
      ...
      value: function _buildDialog() {
        ...
        if (this._type === 'date') {
          ...
          var _title = document.createElement('div'),
              ...
              secondView = document.createElement('div'),
          ...
          _title.appendChild(span2);
          _title.appendChild(second);
      ...
      key: '_initSecond',
      value: function _initSecond() {
        var secondView = this._sDialog.secondView,
            secondNow = parseInt(this._sDialog.tDate.format('m'), 10),
            sSecond = 'mddtp-second__selected',
            selected = 'mddtp-picker__cell--selected',
            rotate = 'mddtp-picker__cell--rotate-',
            cell = 'mddtp-picker__cell',
            docfrag = document.createDocumentFragment();
      ...
      key: '_pointNeedle',
      value: function _pointNeedle(me, type) {
        var spoke = 60,
            value = void 0,
      ...
      value: function _addClockEvent() {
        ...
        secondView.onclick = function (e) {
          var sSecond = 'mddtp-second__selected',
              selectedSecond = document.getElementById(sSecond),
              setSecond = 0;
